...
const ClassItem = (props: IClassItemProps) => {
  const {
    classname,
    joinNum,
    totalNum,
  ...
  return (
    ...
    >
      <View className={'image_container'}>
        <View className={'mask'} />
        <Image src={coverImage} className={'image'} mode={'aspectFill'} />
      </View>
      <View className={'join_txt'}>
        <View className={'member'}>
          已加入：{joinNum}/{totalNum}人
        </View>
        <View className={'title'}>
          ...
          {isJoin ? (
            ...
            <Tag label={'未加入'} bgColor={'#ffe7ba'} labelColor={'#fa8c16'} />
          )}
        </View>
      </View>
    </View>
